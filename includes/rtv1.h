...
*/
void							save_node
(t_object *buff, t_object *source, int *tmp);
int								plane_intersection
(t_env *e, t_object *plane);
int								glass_intersection
(t_env *e, t_object *parent);
int								sphere_intersection
(t_env *e, t_object *sphere);
...
**cast_ray.c
*/
void							init_rayon_values
(t_env *e, t_vector rayon, t_vector origin);
int								cast_ray
(t_env *e, t_vector rayon, t_vector origin);
...
*/
double							noise
(t_env *e, double x, double y, double z);
double							turbulence
(t_env *e, double x, double y, double z);
...
*/
int								sphere_solution
(t_env *e, t_object *sphere, t_poly p);
int								solve_solution(t_env *e, t_poly *p);
int								cylinder_solution
(t_env *e, t_object *cylinder, t_poly p);
int								cone_solution
(t_env *e, t_object *cone, t_poly p);
/*
**texture.c
*/
...
t_color							get_texture_info
(unsigned char *text_data, t_env *e, int sl);
...
(t_env *e, t_object *triangle, t_object *t);
...
*/
t_color							cel_shading
(t_vector *light, t_env *e, t_color *clr);
...
double							get_specular
(t_light *light, t_vector *view, t_vector *node);
void							init_ray_values(t_rayon *ray, t_env *e);
t_color							add_diffuse
(t_env *e, t_color *c, t_light *light, t_rayon *ray);
void							shoot_new_color
(t_env *e, t_color *c, double coef);
void							recurse_color
(t_env *e, t_rayon ray, t_color *c);
t_color							ambient_occlusion(t_env *e);
t_color							get_color(t_env *e);
/*
**area_light.c
*/
t_color							get_area_light_intensity
(t_env *e, t_light *area_light, t_rayon *ray, t_color *c);
void							get_area_light_origin
(t_light *area_light, int nb);
void							init_area_size
(t_object	*al_object, t_light *area_light);
...
void							print_color
(t_color *color, t_env *e, int x, int y);
...
void							matrix_4x4_to_vectors
(t_vector *a, t_vector *b, t_vector *c, t_matrix4x4 *matrix);
t_matrix4x4						matrix_camera_system
(t_vector *a, t_vector *b, t_vector *c);
void							rotation_matrix
(t_matrix4x4 *rotation, t_poly *p);
...
void							matrix_4x1_to_vectors
(t_vector *a, t_matrix4x1 *matrix);
t_matrix4x1						matrix_camera_origin(t_vector *a);
void							update_system_translation
(t_env *e, t_matrix4x4 *rot);
...
*/
void							add_new_light
(t_light **list, t_light *new_light);
void							debug_light(t_light *tmp);
void							create_light(t_env *e, t_json *json);
/*
**create_object.c
*/
void							fill_area_light_infos
(t_json *tmp, t_object *al_object, t_light *al_light);
...
*/
void							add_new_object
(t_object **list, t_object *new_object);
...
void							cylinder_attribut
(t_object *cylinder, t_json *json);
...
void							parse_material
(t_json *material, t_object *object);
...
void							anti_aliasing_clr_merge
(t_color *anti, t_color *clr);
t_anti_a						antialias_loop_init
(t_anti_a *anti, t_env *e, int sample);
...
int								cmp(int a, int b);
void							ft_object_remove_if
(t_object **beg_obj, int data_ref, int (*cmp)());
void							init_copy(t_object **copy, t_object *object);
void							add_object(t_env *e, int x, int y);
int								copy_object(t_env *e, int x, int y);
