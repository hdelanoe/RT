...
void		cube1(t_cube *c, t_object *cb)
{
	...
	if (!(c->carre_1->type = ft_strdup("quad")))
		exit_rt(1);
	c->carre_1->point = set_vector(cb->point.x, cb->point.y, cb->point.z);
	...
	cb->lenght_max, cb->point.z + cb->tangent);
	c->carre_1->point_4 = set_vector(cb->point.x, cb->point.y +
	cb->lenght_max, cb->point.z);
	...
	cb->lenght_max, cb->point.z);
	c->carre_2->point_3 = set_vector(cb->point.x + cb->radius,
	cb->point.y + cb->lenght_max, cb->point.z);
	c->carre_2->point_4 = set_vector(cb->point.x + cb->radius,
...
void		cube2(t_cube *c, t_object *cb)
{
	...
	if (!(c->carre_3->type = ft_strdup("quad")))
		exit_rt(1);
	c->carre_3->point = set_vector(cb->point.x + cb->radius, cb->point.y,
	cb->point.z);
	c->carre_3->point_2 = set_vector(cb->point.x + cb->radius, cb->point.y
	+ cb->lenght_max, cb->point.z);
	c->carre_3->point_3 = set_vector(cb->point.x + cb->radius, cb->point.y
	+ cb->lenght_max, cb->point.z + cb->tangent);
	c->carre_3->point_4 = set_vector(cb->point.x + cb->radius, cb->point.y,
	cb->point.z + cb->tangent);
	...
	if (!(c->carre_4->type = ft_strdup("quad")))
		exit_rt(1);
	c->carre_4->point = set_vector(cb->point.x + cb->radius, cb->point.y +
	cb->lenght_max, cb->point.z + cb->tangent);
	c->carre_4->point_2 = set_vector(cb->point.x + cb->radius, cb->point.y,
	cb->point.z + cb->tangent);
...
void		cube3(t_cube *c, t_object *cb)
{
	...
	cb->lenght_max, cb->point.z + cb->tangent);
	c->carre_5->point_3 = set_vector(cb->point.x + cb->radius,
	cb->point.y + cb->lenght_max, cb->point.z + cb->tangent);
	c->carre_5->point_4 = set_vector(cb->point.x + cb->radius,
	cb->point.y + cb->lenght_max, cb->point.z);
	...
	cb->point.z + cb->tangent);
	c->carre_6->point_3 = set_vector(cb->point.x + cb->radius,
	cb->point.y, cb->point.z + cb->tangent);
	c->carre_6->point_4 = set_vector(cb->point.x + cb->radius,
	cb->point.y, cb->point.z);
...
void		create_cube(t_env *e, t_json *json)
{
	...
	cb->point = v_v_mult(&cb->point, &cb->axis);
	create_cap_cube(cb);
